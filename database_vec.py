...
def create_milvus_collection(collection_name, vector_size = 576):
    ...
    schema = CollectionSchema(
        fields=[vector_uuid, vector_path, vector_feature],
...
def create_new_collection(collection_name, reset_name = False):
...
# create_milvus_collection('your_collection_name')
...
def create_milvus_index(collection, field_name = "embedding"):
    ...
    index_params = {
        ...
        "params": {"nlist": 16384}               # Specify index parameters as needed
    }
...
def milvus_similarity_search(collection, data, limit):
    ...
    results = collection.search(
        ...
        limit=limit,
        expr=None,
        output_fields=['uuid', 'img_path', 'embedding'],
